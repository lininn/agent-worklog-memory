...
关联：OpenSpec change id / Git commit / Issue / 用户请求，可为空

原因：
- 1-3 条，每条只写一个具体原因，尽量不超过 120 字符。

修改：
- 1-3 条，每条只写一个具体修改，尽量不超过 120 字符。

影响文件：
- 只列关键文件或目录，不粘贴完整 diff。
